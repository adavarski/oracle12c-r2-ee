...
On first run, the database will be provisioned. Using a basic command like `docker run `davarski/oracle12c-r2-ee will set defaults for everything. You will also need to monitor the output to get the database password. 
